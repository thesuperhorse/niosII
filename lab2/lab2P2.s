...
_start:
	...
	movia r4,IN_LIST # store IN_LIST address into r4
	...
	movi r7,10 #length of list
	movi r8,0 #initialize counter
...
LOOP:
	#bge r8,r7,LOOP_FOREVER # test for end of IN_LIST **********PART1***********
	
	ldw r17,0(r4) # move value at address value of r4 into r17
...
INCREMENT:
	addi r4,r4,4 # increment list pointer 4 per word
